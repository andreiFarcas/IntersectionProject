...
public class Controller_1 {
    ...
    public static void main(String[] args) {
        ...
        p6.SetName("OP0");
        p6.Value = new TransferOperation("localhost", "1083", "P_I1_TL1");
        pn.PlaceList.add(p6);

        DataTransfer p7 = new DataTransfer();
        p7.SetName("OP1");
        p7.Value = new TransferOperation("localhost", "1083" , "P_I1_TL2");
        pn.PlaceList.add(p7);

        DataTransfer p8 = new DataTransfer();
        p8.SetName("OP2");
        p8.Value = new TransferOperation("localhost", "1083" , "P_I1_TL3");
        pn.PlaceList.add(p8);
        ...
        DataInteger p12 = new DataInteger();
        p12.SetName("Five");
        p12.SetValue(5);
        pn.ConstantPlaceList.add(p11);
        ...
        Condition T4Ct2 = new Condition(t4, "i2", TransitionCondition.IsNull);
